...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-D739O1M;Database=TELERIK;User id=sa;password=Manolita32");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GanttResourceAssignments>(entity =>
            {
                ...
                entity.Property(e => e.Units).HasColumnType("decimal(5, 2)");
            });
            ...
            modelBuilder.Entity<Intraday>(entity =>
            {
                ...
                entity.Property(e => e.Close).HasColumnType("decimal(9, 3)");

                entity.Property(e => e.Date).HasColumnType("datetime");

                entity.Property(e => e.High).HasColumnType("decimal(9, 3)");

                entity.Property(e => e.Low).HasColumnType("decimal(9, 3)");

                entity.Property(e => e.Open).HasColumnType("decimal(9, 3)");
            ...
            modelBuilder.Entity<Weather>(entity =>
            {
                ...
                entity.Property(e => e.Gust).HasColumnType("decimal(5, 2)");

                entity.Property(e => e.Id)
                    .HasColumnName("ID")
                    .ValueGeneratedOnAdd();

                entity.Property(e => e.Rain).HasColumnType("decimal(5, 2)");

                entity.Property(e => e.Snow).HasColumnType("decimal(5, 2)");
                ...
                entity.Property(e => e.Wind).HasColumnType("decimal(5, 2)");
            });
